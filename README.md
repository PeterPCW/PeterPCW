...
Experiment→Iterate→Automate. This leads me in all sorts of directions:
...
There is no greater joy than direct customer success, and I bring these traits everywhere I go:
- 🤨 Cool head
- 🤗 Warm heart
- 💭 Clear thoughts
- ☑️ Concise comms
...
I've tried many different flavors, but I keep coming back to React+Typescript+Python.
